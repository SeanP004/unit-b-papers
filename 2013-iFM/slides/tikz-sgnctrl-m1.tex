...
\begin{tikzpicture}[scale=0.8]
  \fill[white] (-4,-3.5) rectangle +(14,7);
  \uncover<1-2>{
    % approaching block.
...
%    \draw (3.8,2.5) node{\trains};
    ...
    \draw[thick,->,red] (1.5,2) .. controls (2,3) and (3,3)  ..node[fill=white]{\movein} (3.75,2);

    \draw[thick,->,red] (3.75,2) .. controls (4.5,3) and (5.5,3)  ..node[fill=white]{\moveout} (6,2);
  }
\end{tikzpicture}
