...
Pg 2: allows them to evolve -> allowing them to evolve; set of computation predicate $CPred$ -> set of computation predicates $CPred$

Pg 3: Two contact E,F -> Two constants E, F

Pg 5 Section 3.1: t is stands for  -> t stands for; Vice versa, if an event -> Vice versa, an event; All computations of a model starts -> All computations of a model start. 

Pg 7: … in Unit-B is by using the \textem{transient operator} -> … in Unit-B is the \textem{transient operator}

Pg 10: conductors -> drivers
...
Formatting: remove the coloured cross-references for the printed version. 
